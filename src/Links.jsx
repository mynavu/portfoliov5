...
╰──────────────────────────────────────────────────╯
    ...
    return (
      <div className="small banner flex flex-col items-center" ref={contentRef}>
        ...
        <p>&nbsp;</p>
        <p className="big">&nbsp;&nbsp;⛅</p>
        <a className="group red" href='./Resume_2025.pdf' target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="group-hover:hidden">⬦</span><span className="hidden group-hover:inline">⬥</span> Resume</a>
