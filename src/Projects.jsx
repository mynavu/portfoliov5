...
╰──────────────────────────────────────────────────╯
    ...
    return (
      <div className="small banner flex flex-col items-center">
        ...
        <p>↳ AI powered web extension that give text summaries using Gen Alpha dialect.</p>
        <p>&nbsp;</p>
        ...
        <p>↳ Research experiment on human preference for the Golden Ratio.</p>
        <p>&nbsp;</p>
        ...
        <p>↳ Web version of the board game “Guess Who?” with customizable sets and realtime connection.</p>
        <p>&nbsp;</p>
        ...
        <p>↳ Tool that takes inputs (keyword, subreddit, flare) and analyzes the sentiment of Reddit users, then visualizes it with a pie chart.</p>
        <p>&nbsp;</p>
        ...
        <p>↳ Full stack CRUD app for users to geotag images onto a personal globe + collectable digital stamps for each post on a siginificant region.</p>
        <p>&nbsp;</p>
        <p className="text-center">view more on my <a className="green" href="https://github.com/mynavu" target="_blank">GitHub</a></p>
        <p>&nbsp;</p>
        </div>
        <pre>
            {`╰──────────────────────────────────────────────────────────────────────╯`}
